...
(function ($) {
	...
	$.fn.themeswitcher = function (options) {
		...
		var switcherLink = $("<a/>")
				...
				.addClass("ui-selectmenu ui-widget ui-state-default ui-corner-all ui-selectmenu-dropdown")
	...
	//	} else
		...
		function updateTheme(data) {
			...
			var title = settings.buttonpretext + " " + data.title;
			if (title == '' || title == ' ') title = settings.initialtext;
			...
			switcherDiv.find(".jquery-ui-switcher-title").text(title);
