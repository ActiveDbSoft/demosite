...
namespace DemoSite
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<QueryResultsService>();
            services.AddScoped<DataBaseHelper>();
            services.AddScoped<AlternateNamesService>();
            services.AddScoped<VirtualObjectsService>();
            services.AddScoped<QueryStatisticService>();
        }
